...
<div>	
    <fieldset>
        ...
        <input type="checkbox" name="Interested_In[]" value="Pay-Per-Click Campaign Management" /> Pay-Per-Click Campaign Management. <br />
        <input type="checkbox" name="Interested_In[]" value="Usability Testing" /> Usability Testing.<br />
